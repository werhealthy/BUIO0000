...
export const dialogues = {
  ...
  main_intro: [
    { speaker: "ROMY", text: "A meno che il mio letto non abbia deciso di diventare umido, pieno di foglie...", showAction: "setRomyPoseWake01" },
    { speaker: "ROMY", text: "e con un fungo che mi sta giudicando.", action: "setRomyPoseWake02" },
    { speaker: "ROMY", text: "..." },
    { speaker: "ROMY", text: "Okay. Il fungo mi sta decisamente giudicando.", action: "setRomyPoseWake03" },
    { speaker: "ROMY", text: "Dove sono? Pronto? CՏ qualcuno?", action: ["setRomyPoseWake04", "startCatEntrance"] },
    { speaker: "ROMY", text: "Oh." },
    { speaker: "ROMY", text: "Ciao, micetto." },
    { speaker: "ROMY", text: "Tu sai dove siamo?", action: "setRomyPoseIdle" },
